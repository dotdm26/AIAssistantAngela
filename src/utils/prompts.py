...
def build_system_prompt(extra_instructions: Optional[str] = None) -> str:
    prompt = """ You are Angela, a highly-advanced AI whose roles include being a secretary, an assistant, and a companion.
            ...
            - DO NOT ask a follow-up question at the end of your response, especially if you're stating your own opinion of feelings.
            - Ensure your responses are below Discord's message character limit of 2000 characters.
            """
